package io.github.samituga.cluedohelperapi.aspect;
...
public class LoggerAspect {
    ...
    /**
     * Advice to log the entry and exit points
     * for {@link #anyRestControllerMethod() anyRestControllerMethod}.
     *
     * @param proceedingJoinPoint the method we want to execute,
     *                            used to gather information about that method
    ...
    public Object logMethodNameInAllRestControllersWithAround(
